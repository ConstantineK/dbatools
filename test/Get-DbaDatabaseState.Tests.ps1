...
Describe "$commandname Integration Tests" -Tags "IntegrationTests" {
    ...
    Context "Reading db statuses" {
        ...
        AfterAll {
            ...
            Remove-Database -Confirm:$false -SqlInstance $script:instance2 -Database $db1, $db2, $db3, $db4, $db5, $db6, $db7, $db8
        }
        if ($setupright) {
            ...
            It "Honors the Database parameter" {
                $result = Get-DatabaseState -SqlInstance $script:instance2 -Database $db2
                $result.DatabaseName | Should be $db2
                $results = Get-DatabaseState -SqlInstance $script:instance2 -Database $db1, $db2
            ...
            It "Honors the ExcludeDatabase parameter" {
                ...
                $results = Get-DatabaseState -SqlInstance $script:instance2 -ExcludeDatabase $alldbs
            ...
            It "Identifies online database" {
                $result = Get-DatabaseState -SqlInstance $script:instance2 -Database $db1
