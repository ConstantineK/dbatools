...
Describe "$CommandName Unit Tests" -Tag "UnitTests" {
    Context "Validate parameters" {
        ...
        [object[]]$params = (Get-ChildItem function:\Test-DatabaseOwner).Parameters.Keys
    ...
    InModuleScope 'dbatools' {
        Context "Connects to SQL Server" {
            It -Skip "Should not throw" {
                ...
                { Test-DatabaseOwner -SqlInstance 'SQLServerName' } | Should Not throw
            } #It
            ...
            It -Skip "Should return wrong owner information for one database with no owner specified" {
                ...
                $Result = Test-DatabaseOwner -SqlInstance 'SQLServerName'
            ...
            It -Skip "Should call Stop-Function one time if Target Login does not exist on Server" {
                ...
                $null = Test-DatabaseOwner -SqlInstance 'SQLServerName' -TargetLogin 'WrongLogin'
                $assertMockParams = @{
