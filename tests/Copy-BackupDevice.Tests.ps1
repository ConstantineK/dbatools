    ...
    Describe "$commandname Integration Tests" -Tags "IntegrationTests" {
        Context "Setup" {
            BeforeAll {
                ...
                $backupdir = (Get-DefaultPath -SqlInstance $script:instance1).Backup
            ...
            $results = Copy-BackupDevice -Source $script:instance1 -Destination $script:instance2 -WarningVariable warn -WarningAction SilentlyContinue
            if ($warn) {
            ...
            $results = Copy-BackupDevice -Source $script:instance1 -Destination $script:instance2
