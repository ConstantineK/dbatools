...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    Context "Command actually works" {
        $results = Find-Database -SqlInstance $script:instance2 -Pattern Master
        ...
        $results = Find-Database -SqlInstance $script:instance1, $script:instance2 -Pattern Master
        ...
        $results = Find-Database -SqlInstance $script:instance2 -Property ServiceBrokerGuid -Pattern -0000-0000-000000000000
